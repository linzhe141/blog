...
但对这个流程很是模糊，于是学习了如何在github上如何较为规范的提交PR，以及如何合并用户提交的PR
...
- b、我们可以将`test1，test2，test3`这3个commit进行压缩，融入到`feat: 新增bar功能`commit中
...
如果Reviewer没有直接合并给了一下建议，我们可以直接在这个原创分支进行修改并提交，PR会自动更新
