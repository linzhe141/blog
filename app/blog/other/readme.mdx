...
# vue2.6.14(composition api)使用vuecli 打包出来的commonjs模式的库报错
...
报错`Error: [vue-composition-api] must call Vue.use(VueCompositionAPI) before using any functio`
### 1、客户端
- 1、main.js
...
*但是composition-api就会报错`TypeError: Cannot read properties of undefined (reading 'text')"`*
